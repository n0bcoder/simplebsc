...
while True:
	block = resi['status']
	if block == 1:
		print('Pembelian Token Sukses')
		break
	elif block == 0:
		print('Pembelian Token Gagal')
		break
	else:
		print('Mohon Tunggu sedang di proses')

#cetak transaksi beli
telusur = 'https://bscscan.com/tx/' #telusuritx
print(telusur+rs)
###################


#address token yang ingin di jual
contract_id = web3.toChecksumAddress(micin)
...
signed_txn = web3.eth.account.sign_transaction(approve, private_key=akun.private)
tx_token2 = web3.eth.send_raw_transaction(signed_txn.rawTransaction)

#Persiapan Jual
print('Persiapan Menjual Token')
print('Mohon Tunggu!')
print('Cek Jumlah token')
...
while True:
	apr = aresi['status']
	if apr == 1:
		print('Token has been Approved')
		break
	elif apr == 0:
		print('Gagal Di Approve')
		break
	else:
		print('Mohon Tunggu sedang di proses')

cariresiapprove = 'https://bscscan.com/tx/' #telusuritx
print(cariresiapprove+ar)
lanjut = input('Tekan ENTER Jika ingin menjual token')
print('Checking Balance Please wait')
print('Your Balance: ' + str(readable) + " " + symbol)
print('Menukar Token ke BNB')
...
while True:
	...
	if jpr == 1:
		...
		print('Token Gagal Terjual')
		break
	else:
		print('Mohon Tunggu sedang di proses')

jtres = 'https://bscscan.com/tx/' #telusuritx
print(jtres+jt)
